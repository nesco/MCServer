...
// Implements the cLightingThreadHeightMap class representing the thread that processes requests for lighting
...
/// Chunk data callback that takes the chunk data and puts them into cLightingThreadHeightMap's m_BlockTypes[] / m_HeightMap[]:
class cReader :
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// cLightingThreadHeightMap:

cLightingThreadHeightMap::cLightingThreadHeightMap(void) :
	m_World(NULL)
{
}
...
cLightingThreadHeightMap::~cLightingThreadHeightMap()
{
}
...
void cLightingThreadHeightMap::LightChunk(int X, int Z)
{
...
bool cLightingThreadHeightMap::ReadChunks(int a_ChunkX, int a_ChunkZ)
{
	cReader Reader;
...
void cLightingThreadHeightMap::PrepareSkyLight(void)
{
	// Clear seeds:
...
void cLightingThreadHeightMap::PrepareBlockLight(void)
{
	// Clear seeds:
	memset(m_IsSeed1, 0, sizeof(m_IsSeed1));
...
void cLightingThreadHeightMap::CalcLight(NIBBLETYPE * a_Light)
{
	int NumSeeds2 = 0;
	while (m_NumSeeds > 0)
	{
...
void cLightingThreadHeightMap::CalcLightStep(
	NIBBLETYPE * a_Light, 
...
void cLightingThreadHeightMap::CompressLight(NIBBLETYPE * a_LightArray, NIBBLETYPE * a_ChunkLight)
{
