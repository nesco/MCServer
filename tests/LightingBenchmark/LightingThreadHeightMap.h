...
// Interfaces to the cLightingThreadHeightMap class representing the thread that processes requests for lighting
...
class cLightingThreadHeightMap
{
	
public:
	
	cLightingThreadHeightMap(void);
